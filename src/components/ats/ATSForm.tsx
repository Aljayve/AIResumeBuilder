...
export default function ATSForm({ onAnalyze }: Props) {
            ...
            <div className="mb-5 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                        Select a resume and paste the job description to analyze
                    </p>
                </div>
            </div>
            ...
            <div className="space-y-5">
                <div>
                    ...
                    <select
                        ...
                        className="h-11 w-full rounded-lg border border-gray-200 bg-transparent px-3.5 text-sm text-gray-800 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 dark:border-gray-800 dark:bg-white/[0.03] dark:text-white/90"
                    >
                        {resumes.length === 0 && (
